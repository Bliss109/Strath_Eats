    ...
    <div class="container d-flex justify-content-center">
        <div class="card mt-5 px-3 py-4">
            ...
            <div class="media mt-4 pl-2">
                <img src="../Payment System/1200px-M-PESA_LOGO-01.svg.png" class="mr-3" height="75" />
                <div class="media-body">
                    <h5 class="mt-1">Enter Amount & Number</h5>
                </div>
            </div>

            <div class="media mt-3 pl-2">
                <!-- bs5 input-->
                <form action="stk_initiate.php" class="row g-3" method="POST">
